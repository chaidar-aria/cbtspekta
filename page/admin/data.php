                    ...
                    <table class="mb-0 table table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <a class="btn-shadow p-1 btn btn-danger btn-sm text-white" role="button" disabled
                                    onclick="sudahMulai()" id="sudahMulai">Edit
                                    Data</a>
                                <?php } else { ?>
                                <a class="btn-shadow p-1 btn btn-danger btn-sm text-white" role="button"
                                    href="edit?tes_id=<?php echo $row2['test_id']; ?>">Edit Data</a>
                                <?php } ?>
                            </td>
                        </tbody>
                        <?php } ?>
