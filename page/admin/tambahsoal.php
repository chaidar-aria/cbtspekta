        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    TAMBAH DATA <?php echo $row['test_name'] ?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">TAMBAH DATA SOAL</h5>
                        <form action="<?php echo $urlConfig ?>soal" method="post">
                            <div>
                                <div class="form-group">
                                    <label for="username">SOAL</label>
                                    <input type="hidden" name="test_id" value="<?php echo $test_id ?>">
                                    <textarea id="que_desc" rows="10" cols="80" name="que_desc" require></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="username">JAWABAN A</label>
                                    <textarea id="ans1" rows="10" cols="80" name="ans1"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="username">JAWABAN B</label>
                                    <textarea id="ans2" rows="10" cols="80" name="ans2"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="username">JAWABAN C</label>
                                    <textarea id="ans3" rows="10" cols="80" name="ans3"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="username">JAWABAN D</label>
                                    <textarea id="ans4" rows="10" cols="80" name="ans4"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="username">JAWABAN E</label>
                                    <textarea id="ans5" rows="10" cols="80" name="ans5"></textarea>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="que_score" class="form-control"
                                            placeholder="Nilai Soal" aria-label="Nilai Soal"
                                            aria-describedby="basic-addon1" require autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="d-block text-center card-footer">
                                <button type="reset" class="mr-2 btn-icon btn-icon-only btn btn-outline-danger"><i
                                        class="pe-7s-trash btn-icon-wrapper"> </i></button>
                                <button type="submit" class="btn-wide btn btn-success" name="tambahSoal">TAMBAH
                                    SOAL</button>
                            </div>
                        </form>
                    </div>
